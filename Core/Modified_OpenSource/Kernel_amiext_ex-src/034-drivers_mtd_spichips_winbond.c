--- linux_old/drivers/mtd/spichips/winbond.c	1970-01-01 08:00:00.000000000 +0800
+++ linux/drivers/mtd/spichips/winbond.c	2020-06-29 17:02:49.292304891 +0800
@@ -0,0 +1,223 @@
+/*
...
+
+/* Name, ID1, ID2, Operation Mode, Size, Clock, Erase regions, address mode,{ Offset, Erase Size, Erase Block Count } */
...
+	{ "Winbond W25Q01JVSFIQ",  0xEF, 0x2140, 0x001F001F, 0x8000000, 50 * 1000000,  1, 0x01, {{ 0, 64  * 1024, 2048 },} },
+};
+
+static
