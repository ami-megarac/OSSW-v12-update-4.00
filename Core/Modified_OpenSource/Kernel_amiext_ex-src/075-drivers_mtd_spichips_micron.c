--- linux_old/drivers/mtd/spichips/micron.c	2020-06-11 10:21:13.828297632 +0800
+++ linux/drivers/mtd/spichips/micron.c	2020-06-11 10:51:23.136312500 +0800
@@ -0,0 +1,105 @@
+/*
...
+{
+	/* Micron 64 K Sectors */
+	{ "Micron/Numonyx N25Q00"   , 0x20, 0x21BA, 0x001F001F, 0x8000000  , 50 * 1000000, 1, 0x02, {{ 0, 64  * 1024, 2048 },} },
+	{ "Micron/Numonyx N25Q00A"  , 0x20, 0x21BB, 0x001F001F, 0x8000000  , 50 * 1000000, 1, 0x02, {{ 0, 64  * 1024, 2048 },} },
