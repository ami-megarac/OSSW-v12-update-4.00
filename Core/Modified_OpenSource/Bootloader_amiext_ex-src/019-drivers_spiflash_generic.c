--- uboot/drivers/spiflash/generic.c	2020-06-10 15:18:53.830380838 +0800
+++ uboot_p/drivers/spiflash/generic.c	2020-06-10 11:55:47.827421414 +0800
@@ -0,0 +1,1658 @@
+/*
...
+
+	/* Issue Controller Transfer Routine */
+	if ((flash_info[bank].flash_id == 0x002019BA) || (flash_info[bank].flash_id == 0x002020BA) || (flash_info[bank].flash_id == 0x002021BA) || (flash_info[bank].flash_id == 0x002021BB))
+		spi_generic_write_enable(bank,ctrl_drv);
+	retval = ctrl_drv->spi_transfer(bank, &code, 1, SPI_NONE, NULL, 0,0);
+	if ((flash_info[bank].flash_id == 0x002019BA) || (flash_info[bank].flash_id == 0x002020BA) || (flash_info[bank].flash_id == 0x002021BA) || (flash_info[bank].flash_id == 0x002021BB)) 
+		spi_generic_write_disable(bank,ctrl_drv);
...
+
+	if (flash_info[bank].flash_id == 0x002020BA || flash_info[bank].flash_id == 0x002021BA || flash_info[bank].flash_id == 0x002021BB)
+	{
