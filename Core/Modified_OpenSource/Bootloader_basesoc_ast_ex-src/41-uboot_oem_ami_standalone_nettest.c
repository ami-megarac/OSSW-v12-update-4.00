...
--- uboot/oem/ami/standalone/cmd_nettest.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/cmd_nettest.c	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,98 @@
+/*
...
--- uboot/oem/ami/standalone/cmd_slt.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/cmd_slt.c	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,38 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/common_std.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/common_std.c	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,35 @@
+#include <common.h>
...
--- uboot/oem/ami/standalone/common_std.h	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/common_std.h	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,3 @@
...
--- uboot/oem/ami/standalone/Makefile	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/Makefile	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,50 @@
+#
+# (C) Copyright 2013 
...
--- uboot/oem/ami/standalone/nettest/cmd_nettest.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/cmd_nettest.c	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,421 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/COMMINF.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/COMMINF.H	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,1135 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // End COMMINF_H
diff -Naur uboot/oem/ami/standalone/nettest/DEF_SPI.H uboot.new/oem/ami/standalone/nettest/DEF_SPI.H
--- uboot/oem/ami/standalone/nettest/DEF_SPI.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/DEF_SPI.H	2020-06-02 13:53:12.736678155 +0800
@@ -0,0 +1,36 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // DEF_SPI_H
diff -Naur uboot/oem/ami/standalone/nettest/DRAM_SPI.c uboot.new/oem/ami/standalone/nettest/DRAM_SPI.c
--- uboot/oem/ami/standalone/nettest/DRAM_SPI.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/DRAM_SPI.c	2020-06-02 13:55:59.337317303 +0800
@@ -0,0 +1,79 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+}
+#endif // End SPI_BUS
diff -Naur uboot/oem/ami/standalone/nettest/entry.c uboot.new/oem/ami/standalone/nettest/entry.c
--- uboot/oem/ami/standalone/nettest/entry.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/entry.c	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,29 @@
+#include <common.h>
+#include <exports.h>
+#include "stdalone.h"
...
+	return 0;
+}
diff -Naur uboot/oem/ami/standalone/nettest/IO.c uboot.new/oem/ami/standalone/nettest/IO.c
--- uboot/oem/ami/standalone/nettest/IO.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/IO.c	2020-06-02 13:56:07.162339803 +0800
@@ -0,0 +1,381 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+}
+
diff -Naur uboot/oem/ami/standalone/nettest/IO.H uboot.new/oem/ami/standalone/nettest/IO.H
--- uboot/oem/ami/standalone/nettest/IO.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/IO.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,70 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+#endif
+#endif
diff -Naur uboot/oem/ami/standalone/nettest/LAN9303.c uboot.new/oem/ami/standalone/nettest/LAN9303.c
--- uboot/oem/ami/standalone/nettest/LAN9303.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/LAN9303.c	2020-06-02 13:56:15.015880590 +0800
@@ -0,0 +1,532 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+#endif // SUPPORT_PHY_LAN9303
+
diff -Naur uboot/oem/ami/standalone/nettest/LIB.c uboot.new/oem/ami/standalone/nettest/LIB.c
--- uboot/oem/ami/standalone/nettest/LIB.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/LIB.c	2020-06-02 13:56:23.744574897 +0800
@@ -0,0 +1,189 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+
diff -Naur uboot/oem/ami/standalone/nettest/LIB.H uboot.new/oem/ami/standalone/nettest/LIB.H
--- uboot/oem/ami/standalone/nettest/LIB.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/LIB.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,42 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif
diff -Naur uboot/oem/ami/standalone/nettest/LIB_SPI.H uboot.new/oem/ami/standalone/nettest/LIB_SPI.H
--- uboot/oem/ami/standalone/nettest/LIB_SPI.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/LIB_SPI.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,24 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/MAC.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/MAC.c	2020-06-02 13:56:29.381166926 +0800
@@ -0,0 +1,2879 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/MAC.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/MAC.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,154 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/MACTEST.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/MACTEST.c	2020-06-02 13:56:37.488408195 +0800
@@ -0,0 +1,1448 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/Makefile	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/Makefile	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,100 @@
+#
...
--- uboot/oem/ami/standalone/nettest/NCSI.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/NCSI.c	2020-06-02 13:56:47.123264363 +0800
@@ -0,0 +1,998 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/NCSI.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/NCSI.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,156 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // NCSI_H
diff -Naur uboot/oem/ami/standalone/nettest/PCI_SPI.c uboot.new/oem/ami/standalone/nettest/PCI_SPI.c
--- uboot/oem/ami/standalone/nettest/PCI_SPI.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PCI_SPI.c	2020-06-02 13:56:56.977766809 +0800
@@ -0,0 +1,84 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/PHY.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHY.c	2020-06-02 13:57:08.209848346 +0800
@@ -0,0 +1,2462 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+}
+
diff -Naur uboot/oem/ami/standalone/nettest/PHYGPIO.c uboot.new/oem/ami/standalone/nettest/PHYGPIO.c
--- uboot/oem/ami/standalone/nettest/PHYGPIO.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHYGPIO.c	2020-06-02 13:57:13.810233951 +0800
@@ -0,0 +1,204 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+}
+#endif // defined(PHY_GPIO)
diff -Naur uboot/oem/ami/standalone/nettest/PHYGPIO.H uboot.new/oem/ami/standalone/nettest/PHYGPIO.H
--- uboot/oem/ami/standalone/nettest/PHYGPIO.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHYGPIO.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,42 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/PHY.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHY.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,56 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // PHY_H
diff -Naur uboot/oem/ami/standalone/nettest/PHYSPECIAL.c uboot.new/oem/ami/standalone/nettest/PHYSPECIAL.c
--- uboot/oem/ami/standalone/nettest/PHYSPECIAL.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHYSPECIAL.c	2020-06-02 13:57:21.392622424 +0800
@@ -0,0 +1,899 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
diff -Naur uboot/oem/ami/standalone/nettest/PHYSPECIAL.H uboot.new/oem/ami/standalone/nettest/PHYSPECIAL.H
--- uboot/oem/ami/standalone/nettest/PHYSPECIAL.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/PHYSPECIAL.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,41 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // PHYSPECIAL_H
diff -Naur uboot/oem/ami/standalone/nettest/SPIM.c uboot.new/oem/ami/standalone/nettest/SPIM.c
--- uboot/oem/ami/standalone/nettest/SPIM.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/SPIM.c	2020-06-02 13:57:32.352861132 +0800
@@ -0,0 +1,64 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/stdalone.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/stdalone.c	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,44 @@
+#include "stdalone.h"
+#include "COMMINF.H"
+
...
--- uboot/oem/ami/standalone/nettest/stdalone.h	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/stdalone.h	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,12 @@
+#define CMD_MAX 5
+
+typedef struct {
...
--- uboot/oem/ami/standalone/nettest/STDUBOOT.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/STDUBOOT.c	2020-06-02 13:57:40.178375777 +0800
@@ -0,0 +1,236 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/STDUBOOT.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/STDUBOOT.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,19 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/STRESS.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/STRESS.c	2020-06-02 13:57:47.286292754 +0800
@@ -0,0 +1,148 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
--- uboot/oem/ami/standalone/nettest/stubs.c	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/stubs.c	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,237 @@
+#include <common.h>
+#include <exports.h>
+
...
--- uboot/oem/ami/standalone/nettest/SWFUNC.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/SWFUNC.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,283 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
...
+
+#endif // SWFUNC_H
diff -Naur uboot/oem/ami/standalone/nettest/TYPEDEF.H uboot.new/oem/ami/standalone/nettest/TYPEDEF.H
--- uboot/oem/ami/standalone/nettest/TYPEDEF.H	1970-01-01 08:00:00.000000000 +0800
+++ uboot.new/oem/ami/standalone/nettest/TYPEDEF.H	2020-06-02 13:53:12.740677905 +0800
@@ -0,0 +1,114 @@
+/*
+ *  This program is distributed in the hope that it will be useful,
+ *  but WITHOUT ANY WARRANTY; without even the implied warranty of
